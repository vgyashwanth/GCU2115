...
//NewUI
uint8_t ParamInSubmenus[ID_SUB_MENU_LAST] = {4,2,4,4,3,3,6,2,4,4,3,6,6,3,5,5,5,5,5,5,5,5,5,27,35,27,36,32,32,32,2,2,2,2,2,2,2,4,7,11,12,12,12,5,7,7,5,8,7,7,11,13,6,3,3,4,4,9,20,4,5,3,1,3,4,10,1,3,6,4,1,2};
uint8_t SubmenusInMenus[ID_MAIN_MENU_LAST] = {6,8,16,7,3,6,3,10,2,4,3,2,1,1};
//End
