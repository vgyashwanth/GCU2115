...
void ENGINE_MONITORING::prvCheckExtOvldReset()
{
    static uint8_t u8ExtOvldResetCnt = 0U;
    if(u8ExtOvldResetCnt >= NO_OF_50MSEC_TICKS_FOR_1SEC) /*Function is called after 50 ms timeout, at a 1 sec interval*/
    {
        u8ExtOvldResetCnt = 0;
