...
public:
    #define IS_START_STOP_RELAY_J1939_CONFIGURED()   ((_cfgz.GetCFGZ_Param(CFGZ::ID_ENGINE_TYPE)!=CFGZ::ENG_CONVENTIONAL) && \
                                                  _cfgz.GetCFGZ_Param(CFGZ::ID_START_STOP_TO_ECU))


   #define IS_PREHEAT_J1939_CONFIGURED()           ((_cfgz.GetCFGZ_Param(CFGZ::ID_ENGINE_TYPE)!=CFGZ::ENG_CONVENTIONAL)  && \
                                              (_cfgz.GetCFGZ_Param(CFGZ::ID_PREHEAT_TO_ECU)))

   #define IS_ENG_TEMP_J1939_CONFIGURED()          ((_cfgz.GetCFGZ_Param(CFGZ::ID_ENGINE_TYPE)!=CFGZ::ENG_CONVENTIONAL) \
                                                 && (_cfgz.GetCFGZ_Param(CFGZ::ID_CLNT_TEMP_FROM_ENG)))
   #define IS_ENG_LOP_J1939_CONFIGURED()          ((_cfgz.GetCFGZ_Param(CFGZ::ID_ENGINE_TYPE)!=CFGZ::ENG_CONVENTIONAL) \
