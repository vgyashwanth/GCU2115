...
//        ID_AUX_S3_DIG_O_WARNING_THRESHOLD,
        ...
        ID_LOP_FROM_ECU_SHUT_THRESH,
        ID_LOP_FROM_ECU_WARN_THRESH,
...
//        ID_BATTERY_MONITOR_BATTERY_MON_BY_J1939,    //need to remove
        ID_CHARGE_ALT_MON_FAIL_ACTION,
//        ID_CHARGE_ALT_MON_CHARGE_ALT_MON_BY_J1939,  //need to remove
...
//        ID_LOP_FROM_ECU_ACTION,
        ID_LOP_FROM_ECU_SHUTDOWN,
        ID_LOP_FROM_ECU_WARNING,
