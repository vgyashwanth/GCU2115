...
class CFGZ
{
  public:
    ...
    typedef enum
    {
        ...
        /* newly added float variables */
        ID_ABRUPT_SPEED_THRESHOLD,
        ID_ABRUPT_SPEED_DELAY,
    ...
    typedef enum
    {
        ...
        /* newly added uint8 variables */
        ID_ABRUPT_SPEED_MONITOR_EN,
        ID_ABRUPT_SPEED_ACTION,
