...
class CFGZ
{
  public:
    ...
    typedef enum
    {
        ...
        ID_ENG_TEMP_DIG_M_THRESHOLD,
        ID_ENG_TEMP_DIG_M_R1,
        ID_ENG_TEMP_DIG_M_T1,
        ID_ENG_TEMP_DIG_M_R2,
        ID_ENG_TEMP_DIG_M_T2,
        ID_ENG_TEMP_DIG_M_R3,
        ID_ENG_TEMP_DIG_M_T3,
        ID_ENG_TEMP_DIG_M_R4,
        ID_ENG_TEMP_DIG_M_T4,
        ID_ENG_TEMP_DIG_M_R5,
        ID_ENG_TEMP_DIG_M_T5,
        ID_ENG_TEMP_DIG_M_R6,
        ID_ENG_TEMP_DIG_M_T6,
        ID_ENG_TEMP_DIG_M_R7,
        ID_ENG_TEMP_DIG_M_T7,
        ID_ENG_TEMP_DIG_M_R8,
        ID_ENG_TEMP_DIG_M_T8,
        ID_ENG_TEMP_DIG_M_R9,
        ID_ENG_TEMP_DIG_M_T9,
        ID_ENG_TEMP_DIG_M_R10,
        ID_ENG_TEMP_DIG_M_T10,

        ID_SHEL_TEMP_DIG_N_HIGH_TEMP_THRESHOLD,
        ID_SHEL_TEMP_DIG_N_LOW_TEMP_THRESHOLD,
        ID_SHEL_TEMP_DIG_N_R1,
        ID_SHEL_TEMP_DIG_N_T1,
        ID_SHEL_TEMP_DIG_N_R2,
        ID_SHEL_TEMP_DIG_N_T2,
        ID_SHEL_TEMP_DIG_N_R3,
        ID_SHEL_TEMP_DIG_N_T3,
        ID_SHEL_TEMP_DIG_N_R4,
        ID_SHEL_TEMP_DIG_N_T4,
        ID_SHEL_TEMP_DIG_N_R5,
        ID_SHEL_TEMP_DIG_N_T5,
        ID_SHEL_TEMP_DIG_N_R6,
        ID_SHEL_TEMP_DIG_N_T6,
        ID_SHEL_TEMP_DIG_N_R7,
        ID_SHEL_TEMP_DIG_N_T7,
        ID_SHEL_TEMP_DIG_N_R8,
        ID_SHEL_TEMP_DIG_N_T8,
        ID_SHEL_TEMP_DIG_N_R9,
        ID_SHEL_TEMP_DIG_N_T9,
        ID_SHEL_TEMP_DIG_N_R10,
        ID_SHEL_TEMP_DIG_N_T10,
...
//        ID_ENG_CLNT_CALIB_V10,
    ...
    typedef enum
    {
        ...
        ID_GENERAL_TIMER__DEEP_SLP_MODE_DELAY,
  ...
  //      ID_NIGHT_MODE_CONFIG_START_TIME,
    ...
    typedef enum
    {
        ...
        ID_ENG_TEMP_DIG_M_SENSOR_SELECTION,
        ID_ENG_TEMP_DIG_M_DIG_SOURCE,
        ID_ENG_TEMP_DIG_M_DIG_POLARITY,
        ID_ENG_TEMP_DIG_M_DIG_ACTION,
        ID_ENG_TEMP_DIG_M_DIG_ACTIVATION,
        ID_ENG_TEMP_DIG_M_DIG_ACTIVATION_DELAY,
        ID_ENG_TEMP_DIG_M_ACTION,
        ID_ENG_TEMP_DIG_M_OPEN_CKT_WARNING,

        ID_SHEL_TEMP_DIG_N_SENSOR_SELECTION,
        ID_SHEL_TEMP_DIG_N_DIG_SOURCE,
        ID_SHEL_TEMP_DIG_N_DIG_POLARITY,
        ID_SHEL_TEMP_DIG_N_DIG_ACTION,
        ID_SHEL_TEMP_DIG_N_DIG_ACTIVATION,
        ID_SHEL_TEMP_DIG_N_DIG_ACTIVATION_DELAY,
        ID_SHEL_TEMP_DIG_N_HIGH_TEMP_MON_DELAY,
        ID_SHEL_TEMP_DIG_N_DG_RUN_DURATION,
        ID_SHEL_TEMP_DIG_N_OPEN_CKT_NOTIFICATION,
