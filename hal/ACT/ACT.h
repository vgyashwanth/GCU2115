...
public:
    ...
    typedef enum {
        ...
        ACT_MODE_MANUAL,
        ACT_PREHEAT,
        ACT_CALLING_FOR_SCHEDULER_RUN,
        ACT_STOP_PANEL_LOCK,
        ACT_EXTERNAL_PANEL_LOCK,
        ACT_FAIL_TO_CLOSE_GEN_CONT,
        ACT_FAIL_TO_CLOSE_MAINS_CONT,
        ACT_LOADING_VTG_NOT_REACHED,
        ACT_LOADING_FREQ_NOT_REACHED,
        ACT_MPU_LOSS,
        ACT_BTS_BATTERY_HYBRID_MODE,
        ACT_AUTOMATIC_FUEL_TRANSFER,
        ACT_ISV_PULL_SIGNAL,
        ACT_ISV_HOLD_SIGNAL,
        ACT_LOW_IDLE_MODE,
        ...
        ACT_OPEN_GEN_BREAKER_PULSE,
        ACT_CLOSE_GEN_BREAKER_PULSE,
        ACT_OPEN_MAINS_BREAKER_PULSE,
        ACT_CLOSE_MAINS_BREAKER_PULSE,

        ACT_IDLE_MODE_ON_PULSE,
        ACT_IDLE_MODE_OFF_PULSE
