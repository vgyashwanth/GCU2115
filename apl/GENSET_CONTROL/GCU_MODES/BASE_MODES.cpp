...
stTimer BASE_MODES::_ReturnToMainsTimer = {0, false};
stTimer BASE_MODES::_EngCoolDownTimer = {0, false};
stTimer BASE_MODES::_GCUSMUpdateTimer = {0, false};
stTimer BASE_MODES::_BaseModeUpdateTimer = {0, false};
stTimer BASE_MODES::_MainsMonUpdateTimer = {0, false};
...
stTimer BASE_MODES::_ContactorTransferTimer = {0, false};
