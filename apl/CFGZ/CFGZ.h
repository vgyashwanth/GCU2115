...
class CFGZ
{
  public:
    ...
    {
        //RushiStart
        ID_CAN_J1939_COMM_ACT_DELAY_AMBER,
        ID_CAN_J1939_COMM_ACT_DELAY_RED,
        ID_CAN_J1939_COMM_ACT_DELAY_MIL,
        ID_CAN_J1939_COMM_ACT_DELAY_PROTECT,
        ...
        ID_ALARM_DUE_DATE_SERVICE_DATE_3,//Year
    ...
    typedef enum
    {
        ...
        ID_CAN_J1939_COMM_ACTION_AMBER,
        ID_CAN_J1939_COMM_ACTIVATION_AMBER,
        ID_CAN_J1939_COMM_ACTION_RED,
        ID_CAN_J1939_COMM_ACTIVATION_RED,
        ID_CAN_J1939_COMM_ACTION_MIL,
        ID_CAN_J1939_COMM_ACTIVATION_MIL,
        ID_CAN_J1939_COMM_ACTION_PROTECT,
        ID_CAN_J1939_COMM_ACTIVATION_PROTECT,
